...
### 1. `ThreadnestRestApiRoutes.php` - Route Registration
...
### 2. `ThreadnestRestApiController.php` - Controller Callbacks
...
### Base URL: `wp-json/threadnest-chat/v1/`
...
```javascript
// Get threads
fetch('/wp-json/threadnest-chat/v1/threads?page=1&per_page=10')
  .then(response => response.json())
  .then(data => console.log(data.threads));

// Send message
fetch('/wp-json/threadnest-chat/v1/threads/123/messages', {
  method: 'POST',
  headers: {
