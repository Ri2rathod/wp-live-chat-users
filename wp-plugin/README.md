...
**Threadnest** is a modern, high-performance real-time chat system for WordPress. It enables seamless user-to-user communication using WebSocket technology, providing a smooth and responsive experience similar to modern messaging apps.
...
=== 1. Plugin Setup ===
1.  Upload the `threadnest` folder to your `/wp-content/plugins/` directory.
...
=== 3. Configuration ===
1.  Go to **Settings > Threadnest API** in your WordPress dashboard.
