...
## Overview
This WebSocket server implements real-time communication for the Threadnest plugin using Socket.IO. It provides real-time messaging, typing indicators, presence management, and read receipts.
...
WP_API_NAMESPACE=threadnest-chat/v1
